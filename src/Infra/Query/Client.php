    ...
    private function mapEntity(array $results): array
    {
        foreach ($results as &$result) {
            $result = new C(
                ...
                (string) $result->{C::FIELD_TAX_EXEMPT},
                (string) $result->{C::FIELD_LATE_FEE_OVERRIDE},
                (string) $result->{C::FIELD_DUE_NOTICES_OVERRIDE},
                (string) $result->{C::FIELD_SEPARATE_INVOICES},
                (string) $result->{C::FIELD_DISABLE_AUTO_CC},
                (string) $result->{C::FIELD_DATE_CREATED},
